...
CATEGORY_KEYWORDS = {
    "อาหาร":        ["อาหาร", "ข้าว", "กาแฟ", "ชา", "น้ำ", "ร้านอาหาร", "ค่ากิน",
                     "ขนม", "ของกิน", "food", "meal", "lunch", "dinner", "breakfast",
                     "ก๋วยเตี๋ยว", "ส้มตำ", "ชาบู", "บุฟเฟ่"],
    "เดินทาง":      ["เดินทาง", "รถ", "แท็กซี่", "taxi", "grab", "bolt", "บัส", "รถไฟ",
                     "น้ำมัน", "ค่าเดินทาง", "bts", "mrt", "รถไฟฟ้า", "สายการบิน",
                     "ตั๋วเครื่องบิน", "ที่จอดรถ", "ค่าจอดรถ"],
    "ช้อปปิ้ง":     ["ช้อปปิ้ง", "ซื้อของ", "เสื้อผ้า", "รองเท้า", "กระเป๋า",
                     "shopping", "lazada", "shopee", "amazon", "ซื้อ", "ของใช้"],
    "ท่องเที่ยว":   ["ท่องเที่ยว", "เที่ยว", "โรงแรม", "ที่พัก", "ตั๋ว", "travel",
                     "hotel", "resort", "airbnb", "hostel"],
    "ความบันเทิง":  ["บันเทิง", "หนัง", "คอนเสิร์ต", "เกม", "streaming",
                     "netflix", "spotify", "youtube", "disney", "ค่าสมาชิก"],
    "สุขภาพ":       ["สุขภาพ", "ยา", "หมอ", "โรงพยาบาล", "คลินิก", "ออกกำลัง",
                     "gym", "fitness", "ค่ายา", "ค่าหมอ", "ฟิตเนส", "วิตามิน"],
    "ค่าธรรมเนียม": ["ค่าธรรมเนียม", "บิล", "ค่าน้ำ", "ค่าไฟ", "ค่าเน็ต",
                     "internet", "ค่าโทรศัพท์", "ประกัน", "insurance", "fee",
                     "ค่าเช่า", "ค่าบ้าน", "ค่าห้อง"],
